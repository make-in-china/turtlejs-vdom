...
(function (VMDOM) {
    ...
    function setInDOM(node, parent, v) {
    ...
    VMDOM.VNodeVMData = function () {
        ...
        this.$setParentNode = this.$.getEventHelper("setParentNode");
        this.$beforeSetInDOM = this.$.getEventHelper("beforeSetInDOM");
        this.$setInDOM = this.$.getEventHelper("setInDOM");
...
var VMDOM;
(function (VMDOM) {
    var VExConstructor = VMDOM.VElement;
    var VEx = VExConstructor.prototype;
    delete VExConstructor.prototype;
    VMDOM.VElement = function () {
        VExConstructor.apply(this);
        this.vmData.events = [];
    };
...
var VMDOM;
(function (VMDOM) {
    var VExConstructor = VMDOM.VDocumentType;
    var VEx = VExConstructor.prototype;
    delete VExConstructor.prototype;
...
var VMDOM;
(function (VMDOM) {
    var VExConstructor = VMDOM.VHTMLElement;
    var VEx = VExConstructor.prototype;
    var doBaseToDOM = Object.getOwnPropertyDescriptor(VEx, 'doBaseToDOM').value;
    Object.defineProperty(VEx, 'doBaseToDOM', {
        value: function () {
            var elem = doBaseToDOM.call();
...
var VMDOM;
(function (VMDOM) {
    var VExConstructor = VMDOM.VScriptElement;
    var VEx = VExConstructor.prototype;
    delete VExConstructor.prototype;
    VMDOM.VScriptElement = function () {
        var _this = this;
        VExConstructor.apply(this);
        this.vmData.$beforeSetInDOM.on(function (node, parent, document) {
            if (document) {
                //不是从dom里删除
                if (node.vmData.document) {
                    if (document !== node.vmData.document) {
                        //换一个dom
                        document.scripts.push(_this);
                    }
                    else {
                        //同一个dom换位置
                        return;
            ...
            var idx = document.scripts.indexOf(_this);
...
"use strict";
/**
 * 一些标签会注册自己的实例到document的属性里，如document.body等
 *
 * 一些标签的id变化时会更改全局的命名
 */ 
"use strict";
